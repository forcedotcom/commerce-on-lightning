...
-   add setup guide to create commerce scratch org and stores ([c226cea](https://github.com/forcedotcom/commerce-on-lightning/commit/c226ceabd8b8107b16872cdef15f356de47c1e1c))
-   update README for checkout example ([6ec32d6](https://github.com/forcedotcom/commerce-on-lightning/commit/6ec32d61ea698b96a5c0675308f7dc50425f7aca))
-   update repo README to clarify dependencies and installation process ([3296e66](https://github.com/forcedotcom/commerce-on-lightning/commit/3296e66387a5a66d337acbf3f5d94f2e949126e1))

### Bug Fixes

-   resolve issue with `urlPathPrefix` in `ExperienceBundle`([6b2aa50](https://github.com/forcedotcom/commerce-on-lightning/commit/6b2aa5037491fd9a6b848d9649ac3c98c7625937))
