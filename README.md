...
@salesforce/commerce/242.0.7 darwin-arm64 node-v16.17.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
* [`sfdx commerce:scratchorg:create -a <string> -u <string> [-g <string>] [-t <string>] [-v <string>] [-w <minutes>] [-y] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-commercescratchorgcreate--a-string--u-string--g-string--t-string--v-string--w-minutes--y---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
_See code: [src/commands/commerce/examples/convert.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/examples/convert.ts)_
...
_See code: [src/commands/commerce/extension/map.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/extension/map.ts)_
...
_See code: [src/commands/commerce/extension/points/list.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/extension/points/list.ts)_
...
_See code: [src/commands/commerce/extension/register.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/extension/register.ts)_
...
_See code: [src/commands/commerce/extension/unmap.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/extension/unmap.ts)_
...
_See code: [src/commands/commerce/files/copy.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/files/copy.ts)_
...
_See code: [src/commands/commerce/payments/quickstart/setup.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/payments/quickstart/setup.ts)_
...
_See code: [src/commands/commerce/products/import.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/products/import.ts)_

## `sfdx commerce:scratchorg:create -a <string> -u <string> [-g <string>] [-t <string>] [-v <string>] [-w <minutes>] [-y] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Create a scratch org

```
USAGE
  $ sfdx commerce:scratchorg:create -a <string> -u <string> [-g <string>] [-t <string>] [-v <string>] [-w <minutes>] 
  [-y] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]

OPTIONS
  -a, --hub-org-admin-username=hub-org-admin-username                               (required) username of the hub org
                                                                                    admin

  -g, --scratch-org-alias=scratch-org-alias                                         Alias name for this scratch org

  -t, --type=type                                                                   [default: both] b2b, b2c or both

  -u, --scratch-org-admin-username=scratch-org-admin-username                       (required) username of the admin to
                                                                                    associate with the scratch org.

  -v, --api-version=api-version                                                     [default: 57.0] Version of current
                                                                                    Salesforce

  -w, --wait=wait                                                                   [default: 15 minutes] The streaming
...
_See code: [src/commands/commerce/scratchorg/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/scratchorg/create.ts)_
...
_See code: [src/commands/commerce/store/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/store/create.ts)_
...
_See code: [src/commands/commerce/store/display.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/store/display.ts)_
...
_See code: [src/commands/commerce/store/open.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/store/open.ts)_
...
_See code: [src/commands/commerce/store/quickstart/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/store/quickstart/create.ts)_
...
_See code: [src/commands/commerce/store/quickstart/setup.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v242.0.7/src/commands/commerce/store/quickstart/setup.ts)_
<!-- commandsstop -->
