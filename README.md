...
@salesforce/commerce/244.0.19 darwin-x64 node-v16.17.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/commerce/examples/convert.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/examples/convert.ts)_
...
_See code: [src/commands/commerce/extension/map.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/extension/map.ts)_
...
_See code: [src/commands/commerce/extension/points/list.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/extension/points/list.ts)_
...
_See code: [src/commands/commerce/extension/register.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/extension/register.ts)_
...
_See code: [src/commands/commerce/extension/unmap.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/extension/unmap.ts)_
...
_See code: [src/commands/commerce/files/copy.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/files/copy.ts)_
...
_See code: [src/commands/commerce/ordermanagement/quickstart/setup.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/ordermanagement/quickstart/setup.ts)_
...
_See code: [src/commands/commerce/payments/quickstart/setup.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/payments/quickstart/setup.ts)_
...
_See code: [src/commands/commerce/products/import.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/products/import.ts)_
...
_See code: [src/commands/commerce/scratchorg/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/scratchorg/create.ts)_
...
_See code: [src/commands/commerce/search/start.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/search/start.ts)_
...
OPTIONS
  ...
  -t, --templatename=templatename
      Template to use to create a site. If none specified, it will get the template from the corresponding store scratch
      file based on the store type (b2b or b2c).
...
_See code: [src/commands/commerce/store/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/store/create.ts)_
...
_See code: [src/commands/commerce/store/display.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/store/display.ts)_
...
_See code: [src/commands/commerce/store/open.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/store/open.ts)_
...
OPTIONS
  ...
  -t, --templatename=templatename
      [default: b2c-lite-storefront] Template to use to create a site. If none specified, it will get the template from
      the corresponding store scratch file based on the store type (b2b or b2c).
...
_See code: [src/commands/commerce/store/quickstart/create.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/store/quickstart/create.ts)_
...
_See code: [src/commands/commerce/store/quickstart/setup.ts](https://github.com/forcedotcom/commerce-on-lightning/blob/v244.0.19/src/commands/commerce/store/quickstart/setup.ts)_
